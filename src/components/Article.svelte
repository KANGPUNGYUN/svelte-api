<script>
    ...
    import ArticleEditForm from '../components/ArticleEditForm.svelte'
    import {router} from 'tinro'
    import dateView from '../utils/date';

    let isVeiwMenu = false
  ...
  <div class="slog-content-box" >
      <div class="content-box-header">
        ...
        <div class="content-box-header-inner-right">
          {#if article.userId === $auth.id}
            ...
            <div class="drop-menu-box block" class:block={isVeiwMenu}>
              <ul>
      ...
      <div class="content-box-bottom">
        ...
        <div class="button-box-inner-right">
          <!-- 팝업형태로 상세페이지 구현했기 때문에 뒤로가기해도 페이지에 대한 정보를 로드하지 않음 -->
